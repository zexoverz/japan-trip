...
const days = [
  ...
  },
  {
    ...
    isBicycleDay: false,
    fitness: { type: 'push', label: '💪 5:30 Push Day', detail: '5:30 in room: Push-ups (wide) 4×15, diamond push-ups 3×12, pike push-ups 3×10, chair dips 3×12, plank 3×45s, bicycle crunches 3×20, mountain climbers 3×30s. Done by 6:00 → shower → museum day starts relaxed.' },
    ...
    schedule: [
      ...
      { time: '09:00', emoji: '📦', text: 'Pack all bags. CHECK OUT hostel (Piece Hostel). Leave luggage at Kyoto Station coin lockers (¥400-700) — they\'re right at the station, large size fits suitcase.' },
      ...
      { time: '16:00', emoji: '📦', text: 'Pick up luggage from Kyoto Station coin lockers' },
      { time: '16:30', emoji: '🚃', text: 'Bus or taxi to Gion area (15 min) with luggage' },
      { time: '17:00', emoji: '🏯', text: '✨ CHECK IN: Traditional Ryokan in Gion. Drop bags, change into yukata.' },
    ...
    tips: [
      'LUGGAGE: Check out hostel morning → coin locker at Kyoto Station (¥400-700, large size fits suitcase) → pick up before ryokan check-in at 16:00.',
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '05:40', emoji: '🚿', text: 'Shower → pack all bags' },
      { time: '07:00', emoji: '📦', text: 'CHECK OUT ryokan. Take all luggage → taxi/bus to Kyoto Station (15 min)' },
      { time: '07:30', emoji: '🔒', text: 'Store bags in Kyoto Station coin lockers (¥400-700). Travel light to Nara!' },
      { time: '08:00', emoji: '🍙', text: 'Breakfast at konbini in station' },
