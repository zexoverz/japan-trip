...
const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '09:15', emoji: '🚌', text: '🗺️ Station → Hotel: Gifu Bus from JR Gifu Station bus stop #11 → "Nagaragawa Onsen" stop (~15 min, ¥220). OR taxi ~10 min, ~¥1,500. Hotel is 3.5km north on the river — NOT walkable with luggage.' },
      { time: '09:30', emoji: '🏨', text: 'Arrive Miyako Hotel. Drop bags at front desk (check-in at 15:00). They\'ll hold luggage for free.' },
      ...
      { time: '14:00', emoji: '🏨', text: '✨ CHECK IN Miyako Hotel — river-view room, change into yukata, settle in' },
      { time: '15:00', emoji: '♨️', text: 'First onsen soak — hotel has Nagaragawa Onsen natural hot spring bath with river views!' },
      { time: '16:30', emoji: '🚶', text: 'Walk along Nagara River — beautiful at golden hour. Gifu feels untouched by tourism.' },
      { time: '18:00', emoji: '🍽️', text: 'Dinner at hotel restaurant (Japanese/Western options) or walk to local izakaya near the river' },
      { time: '20:00', emoji: '♨️', text: 'Night onsen — second soak hits different. River sounds + warm water.' },
      { time: '21:00', emoji: '😴', text: 'Sleep well — Nagara River views from the room' },
    ],
    tips: [
      'Miyako Hotel check-in is 15:00 but they\'ll hold your bags from morning. Explore Gifu first!',
      'Hotel has 3 restaurants + Nagaragawa Onsen natural hot spring. 4-star comfort, not budget.',
  ...
  {
    day: 7, date: 'Apr 27 (Mon)', title: '♨️ Slow Ryokan Morning + Monet\'s Pond 🎨',
    ...
    summary: 'Dawn onsen, slow breakfast, bus to magical Monet\'s Pond. Afternoon explore Gifu at your pace. Same hotel, no checkout stress.',
    dayCost: '¥4,000-6,000 (bus + food)',
    schedule: [
      { time: '06:00', emoji: '♨️', text: 'Dawn onsen — barely anyone, morning light on the water. Best soak of the trip.' },
      { time: '07:00', emoji: '🍽️', text: 'Hotel breakfast — fuel up for the day' },
      { time: '08:30', emoji: '☕', text: 'Slow morning — no checkout today! Same hotel. Leave bags in room.' },
      { time: '08:45', emoji: '🚌', text: '🗺️ Hotel → Bus: Gifu Bus from "Nagaragawa Onsen" stop (near hotel) → JR Gifu Station (~15 min). Transfer to Itadori/Hōrado-bound bus (~1h). Check timetable night before — buses are infrequent!' },
      ...
      { time: '14:00', emoji: '🚶', text: 'Back in Gifu! Explore Kawaramachi old town, riverside walk, craft shops' },
      { time: '15:30', emoji: '🍵', text: 'Find a local café or tea house. No rush — enjoy Gifu at walking pace.' },
      { time: '16:30', emoji: '🛍️', text: 'Souvenir browse or just sit by the Nagara River' },
      { time: '17:30', emoji: '♨️', text: 'Back to hotel — afternoon onsen soak before dinner' },
      { time: '18:30', emoji: '🍽️', text: 'Dinner: local izakaya near the river or hotel restaurant' },
      { time: '20:00', emoji: '♨️', text: 'Night onsen — last soak. Tomorrow you head to the mountains.' },
      { time: '21:00', emoji: '😴', text: 'Early rest — Takayama adventure starts tomorrow!' },
    ],
    tips: [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '07:30', emoji: '📦', text: 'CHECK OUT Miyako Hotel' },
      { time: '07:45', emoji: '🚌', text: '🗺️ Hotel → Station: Gifu Bus "Nagaragawa Onsen" → JR Gifu Station (~15 min, ¥220). OR taxi ~10 min, ~¥1,500.' },
      ...
      { time: '10:20', emoji: '🚶', text: '🗺️ Station → Hotel: WALK 7 min east from Takayama Station. Cross the bridge, K\'s House is on the right side of Sanno-machi street.' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '06:15', emoji: '🚿', text: 'Shower → breakfast → pack' },
      { time: '07:30', emoji: '📦', text: 'CHECK OUT guesthouse' },
      { time: '08:00', emoji: '🚃', text: 'JR Hida Express: Takayama → Nagoya (2h 20min, covered by JR Pass!)' },
      ...
      { time: '12:55', emoji: '🚶', text: 'WALK 3-5 min from Akihabara Station to APA Hotel (or your chosen hotel). Flat, easy with luggage.' },
      { time: '13:15', emoji: '🏨', text: 'Check in hotel. Drop bags. Game face on. 🎯' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '09:30', emoji: '🏨', text: 'Check out hotel' },
      { time: '10:00', emoji: '🚃', text: 'Head to airport — Narita Express (1h, ¥3,250) or Skyliner (41 min, ¥2,520)' },
