...
const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '11:55', emoji: '🍙', text: '**Quick konbini lunch** — onigiri + sandwich + drink ¥800. Eat on walk to bus terminal (2 min walk).' },
      { time: '— SHIRAKAWA-GO —', emoji: '🏘️', text: '══════════════ UNESCO AFTERNOON ══════════════' },
      { time: '12:20', emoji: '🚶', text: 'Walk Country Hotel → **Takayama Nohi Bus Center** (2 min, sebelahan station)' },
      { time: '12:40', emoji: '🚌', text: 'Nohi Bus Takayama → Shirakawa-go (50 menit, ¥2,600 one-way / ¥4,420 round-trip discount). **Booking malam Day 8 wajib** Golden Week!' },
      { time: '13:30', emoji: '🏘️', text: 'Arrive Shirakawa-go — UNESCO World Heritage village' },
      { time: '13:45', emoji: '🚶', text: '**Walk village 2km loop** — gassho-zukuri farmhouses 250+ tahun, masih lived in. Cherry blossoms late season possible!' },
      { time: '14:30', emoji: '🏠', text: '**Wada House** atau **Kanda House** ¥300-400 — interior tour, irori fireplace smoke, attic silk farming room' },
