...
const days = [
  ...
  },
  {
    ...
    schedule: [
      { time: '06:30', emoji: '☕', text: 'Wake, konbini breakfast — ringan karena cycling 2.5 jam coming' },
      ...
      { time: '08:00', emoji: '🎫', text: '**Rent bicycle.** Best options dekat Country Hotel: 1) **Hara Bicycle (原自転車)** — JR Station area, 5 min walk, ¥1,000/day mama-chari atau ¥1,500-2,000 e-bike. 2) **Takayama Cycle** — sebelahan station. 3) **Country Hotel front desk** — kadang punya rental free/cheap untuk guests, TANYA dulu pagi.' },
      { time: '08:15', emoji: '🚲', text: '**Get e-bike kalau available** — Hida ada gentle grades, e-bike effortless. ¥500 extra worth it.' },
      { time: '— ROUTE START —', emoji: '🗺️', text: '══════════════ CYCLING 18KM LOOP ══════════════' },
      { time: '08:30', emoji: '🚲', text: '**START** — Head SOUTH along Miyagawa River bike path. Flat, scenic.' },
      { time: '08:45', emoji: '📸', text: '**Nakabashi Bridge** crossing — morning light, different vibe dari Day 8 evening (1.5km from start)' },
      { time: '09:00', emoji: '⛩️', text: 'Pass through **Higashiyama temple area** — bike through tree-lined temple street (3km from start)' },
      { time: '09:15', emoji: '🌾', text: 'Enter **countryside south Takayama** — quiet roads, rice paddies start, mountain backdrop. Real Hida vibe. (5km)' },
      { time: '09:30', emoji: '🏛️', text: '🎯 **HIDA FOLK VILLAGE (飛騨の里 / Hida no Sato)** ¥700 — **MAIN STOP**. Open-air museum: 30+ traditional gassho-zukuri thatched-roof farmhouses relocated dari seluruh Hida. Lake center, walking paths. **1.5 jam quality visit.** (7km from start)' },
      { time: '11:00', emoji: '🚲', text: 'Continue WEST countryside — parallel return route, more rice paddies + mountain views (11km)' },
      { time: '11:30', emoji: '⛩️', text: '**Sumiyoshi Shrine** quick stop — small local shrine, free, 10 menit (13km)' },
      { time: '11:45', emoji: '📸', text: 'Quiet riverside spot — mountain reflections, brief pause' },
      { time: '12:00', emoji: '🚲', text: 'Return ke Takayama center via Miyagawa east bank (17km)' },
      { time: '12:15', emoji: '🎫', text: '**Return bike** rental shop. Pay if not pre-paid. (18km total cycled)' },
      { time: '12:30', emoji: '🍜', text: '**Quick lunch** — Takayama ramen (¥800) atau soba (¥1,000) dekat station. **Cutting:** clear broth ramen > cream/tonkotsu.' },
      { time: '— SHIRAKAWA-GO —', emoji: '🏘️', text: '══════════════ UNESCO AFTERNOON ══════════════' },
      { time: '13:00', emoji: '🚌', text: '🚌 Nohi Bus Takayama → Shirakawa-go (50 menit, ¥2,600 one-way / ¥4,420 round-trip discount). **Booking malam Day 8 wajib** Golden Week!' },
      { time: '13:50', emoji: '🏘️', text: 'Arrive Shirakawa-go — UNESCO World Heritage village' },
      { time: '14:00', emoji: '🚶', text: '**Walk village 2km loop** — gassho-zukuri farmhouses 250+ tahun, masih lived in. Cherry blossoms late season possible!' },
      { time: '14:45', emoji: '🏠', text: '**Wada House** atau **Kanda House** ¥300-400 — interior tour, irori fireplace smoke, attic silk farming room' },
      { time: '15:30', emoji: '🥾', text: '🎯 **Shiroyama Viewpoint hike** — 15 menit uphill walk, **THE postcard view** ALL of Shirakawa-go from above. **MUST DO.**' },
      { time: '16:00', emoji: '📸', text: 'Photos top + descent. Multiple angles.' },
      { time: '16:15', emoji: '🛍️', text: 'Browse Shirakawa craft shops — local mochi, Sarubobo Shirakawa version' },
      { time: '16:30', emoji: '🚌', text: '🚌 **Last bus back Takayama** — usually depart 16:30-17:00. **DON\'T MISS!**' },
      { time: '17:30', emoji: '🏨', text: 'Back Takayama, walk Country Hotel relax 30 menit' },
      { time: '18:00', emoji: '🛁', text: 'Hotel basic shower, change' },
    ...
    tips: [
      '🚲 **Bike rental dekat Country Hotel Takayama:** 1) **Hara Bicycle (原自転車)** — 5 min walk, ¥1,000/day mama-chari, ¥1,500-2K e-bike. 2) **Takayama Cycle** — sebelahan JR station. 3) **Country Hotel front desk** — tanya dulu, kadang rental free/cheap untuk guests. **Best: e-bike kalau available** (¥500 extra worth it, Hida ada gentle grades).',
      '🗺️ **18km route highlights:** Miyagawa River → Nakabashi → Higashiyama temple area → countryside south → **Hida Folk Village ¥700 (1.5h MAIN stop)** → rice paddies → Sumiyoshi Shrine → return. Mostly flat, paved, well-marked.',
      ...
      '🚌 **Shirakawa-go bus URGENT booking** — Golden Week Friday rawan sold out. Beli round-trip discount ¥4,420 (vs ¥5,200 one-way each). Book Day 8 malam di Nohi Bus Center counter.',
