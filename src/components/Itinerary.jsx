...
const days = [
  ...
  {
    day: 5, date: 'Apr 25 (Sat)', title: 'Kyoto Museums + Gion Night 🏛️',
    city: 'Kyoto', cityColor: 'bg-orange-100 text-orange-600',
    theme: 'Culture & Art',
    isBicycleDay: false,
    fitness: { type: 'push', label: '💪 5:30 Push Day', detail: '5:30 in room: Push-ups, diamond push-ups, pike push-ups, dips, plank, crunches, mountain climbers. Done by 6:00.' },
    image: 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?w=600&q=75',
    summary: '1,001 golden statues, manga museum paradise, Gion evening walk. Last night at Kyoto hostel.',
    dayCost: '¥5,000-7,000',
    schedule: [
      ...
      { time: '18:00', emoji: '🏮', text: 'Gion evening walk — Hanamikoji street (spot real maiko/geisha at dusk!)' },
      { time: '19:00', emoji: '🍽️', text: 'Dinner: Pontocho Alley — river-facing terraces, farewell Kyoto dinner' },
      { time: '20:30', emoji: '⛩️', text: 'Yasaka Shrine — beautiful lit up at night, free entry' },
      { time: '21:00', emoji: '📦', text: 'Back to hostel. Pack bags for tomorrow — checking out, heading to Nagoya.' },
    ],
    tips: [
      'Sanjusangen-do is one of the most underrated spots in Japan — don\'t skip it!',
      'Last night at Piece Hostel. Pack tonight — early checkout tomorrow for Nara + Nagoya.',
    ],
  },
  {
    ...
    isBicycleDay: false,
    fitness: { type: 'run', label: '🏃 5AM Run Only', detail: '5:00 Last Kamogawa River run (5km easy). No weights today — travel day + Nara walking (15K+ steps). Run → shower → check out → Nara.', run: 'Kamogawa River Path, 5km easy' },
    ...
    schedule: [
      ...
      { time: '05:40', emoji: '🚿', text: 'Shower → final pack' },
      { time: '07:00', emoji: '📦', text: 'CHECK OUT hostel. Walk to Kyoto Station (bags → coin locker ¥400-700). Travel light to Nara!' },
      { time: '07:30', emoji: '🍙', text: 'Breakfast at konbini in station' },
  ...
  },
  {
    ...
    isBicycleDay: false,
    fitness: { type: 'run+pull', label: '🏃 5AM Run + 🦾 Pull', detail: '5:00 Nagoya Castle + Meijo Park loop (4-6km) → 5:40 Back at hotel → Pull: doorframe rows 4×12, superman holds 3×30s, reverse snow angels 3×15, backpack curls 3×15, plank shoulder taps 3×20. Done by 6:10 → free breakfast → Monet\'s Pond day.', run: 'Nagoya Castle + Meijo Park Loop, 4-6km' },
  ...
  {
    day: 8, date: 'Apr 28 (Tue)', title: 'Takayama — Alps + Ryokan Night 🏔️🏯',
    city: 'Takayama', cityColor: 'bg-emerald-100 text-emerald-700',
    theme: '🏔️ Alps + Ryokan',
    isBicycleDay: false,
    fitness: { type: 'run+legs', label: '🏃 5AM Run + 🦵 Legs', detail: '5:00 Miyagawa River + Higashiyama Trail (5-7km, THE most scenic run of the trip!) → 5:50 Back → Legs: squats 4×20, jump squats 3×10, Bulgarian splits 3×12, calf raises 4×20. Done by 6:15 → shower → morning market opens 6:30!', run: 'Miyagawa River → Higashiyama Trail, 5-7km' },
    image: 'https://images.unsplash.com/photo-1480796927426-f609979314bd?w=600&q=75',
    summary: 'Scenic alpine train, old town, Hida beef, sake — then RYOKAN night! Kaiseki dinner + onsen in the mountains.',
    ...
    schedule: [
      ...
      { time: '10:15', emoji: '🏯', text: 'Drop bags at ryokan (most allow early bag drop even if check-in is later). Or use station coin locker.' },
      ...
      { time: '17:00', emoji: '🏯', text: '✨ CHECK IN ryokan — change into yukata, explore the building' },
      { time: '17:30', emoji: '♨️', text: 'Ryokan onsen — mountain hot spring bath. Way better than public sento!' },
      { time: '18:30', emoji: '🍽️', text: 'KAISEKI DINNER at ryokan — multi-course Hida beef + local mountain cuisine. The meal of the trip.' },
      { time: '20:00', emoji: '🚶', text: 'Evening walk through quiet Takayama streets in yukata' },
      { time: '21:00', emoji: '😴', text: 'Sleep on futon in tatami room — mountain silence, total peace' },
    ],
    tips: [
      'RYOKAN HERE is smarter than Kyoto — cheaper (¥15-20K vs ¥25K+), less crowded, mountain onsen > city onsen.',
      'Book on Rakuten Travel or Jalan.net for best ryokan prices in Takayama.',
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '07:00', emoji: '📦', text: 'CHECK OUT ryokan. Drop bags at K\'s House guesthouse (tonight\'s stay) or station locker.' },
      { time: '07:30', emoji: '🍙', text: 'Breakfast at konbini' },
  ...
  },
  {
    ...
    isBicycleDay: false,
    fitness: { type: 'run', label: '🏃 5AM Run (farewell Takayama)', detail: '5:00 Last Miyagawa River run (3-5km easy pace). No weights — travel day. Run → shower → check out → train. Onsen recovery tonight in Hakone!', run: 'Miyagawa River, 3-5km easy' },
    image: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=600&q=75',
  ...
  },
  {
    ...
    theme: '🗻 Nature & Views',
    isBicycleDay: false,
    fitness: { type: 'push', label: '💪 5:30 Push Day', detail: '5:30 in room: Push-ups 4×15, diamond push-ups 3×12, pike push-ups 3×10, dips 3×12, plank 3×45s, crunches 3×20. Full Hakone loop = lots of walking + hiking.', run: 'Hakone River Valley (optional 3-5km if legs fresh)' },
    image: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=600&q=75',
