...
const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '09:15', emoji: '🏨', text: 'Walk to Miyako Hotel Gifu Nagaragawa (10 min drive from station). Drop bags at front desk (check-in later).' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '09:00', emoji: '🚌', text: 'Gifu Bus from Gifu Station → Itadori/Hōrado area (~1-1.5h). Check timetable night before — buses are infrequent!' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '12:40', emoji: '🏙️', text: 'Arrive Tokyo! Drop bags at hotel near Akihabara/Ueno.' },
      { time: '13:30', emoji: '🏨', text: 'Check in hotel. Game face on. 🎯' },
