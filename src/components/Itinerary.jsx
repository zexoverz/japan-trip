...
const days = [
  ...
  },
  {
    ...
    summary: 'Slow morning Hotel Livemax, bus ke magical Monet\'s Pond, private couples onsen at 300-year Juhachiro ryokan. Same hotel, no checkout stress.',
    dayCost: '¥7,000-10,000 (bus + food + private onsen)',
    schedule: [
      { time: '06:30', emoji: '☕', text: 'Slow morning — no checkout. Coffee/breakfast konbini atau hotel kalau included.' },
      { time: '07:30', emoji: '🗿', text: 'Optional: Gifu Great Buddha kalau lu skip Day 6 sore (closes 17:00). Quick visit 30 menit, ¥200.' },
      { time: '08:30', emoji: '🎒', text: 'Pack daypack: kamera, sunblock, snack, water. Leave main bags di hotel room.' },
      { time: '08:45', emoji: '🚌', text: '🗺️ Walk 5 min Hotel → JR Gifu Station Bus Terminal. Ambil Itadori/Hōrado-bound bus (~1h). **CRITICAL: cek timetable malem sebelum** — bus infrequent (3-4x/day)!' },
      { time: '10:30', emoji: '🎨', text: 'Arrive near Monet\'s Pond. Short walk ke Nemichi Shrine.' },
      { time: '10:45', emoji: '✨', text: '**Monet\'s Pond (Namonaki Ike)** — crystal clear water, colorful koi, water lilies. Looks EXACTLY like Monet painting. FREE!' },
      { time: '11:15', emoji: '📸', text: 'Photos different angles. Walk around shrine grounds. Total serenity.' },
      { time: '11:45', emoji: '🍜', text: 'Lunch local mountain restaurant near pond — soba noodles, mountain vegetables, simple ¥1,000-1,800.' },
      { time: '12:30', emoji: '🚌', text: 'Bus back to Gifu (~1-1.5h). Countryside views dari window.' },
      { time: '14:00', emoji: '🚌', text: 'Back Gifu Station → bus to Nagaragawa Onsen area (15 min, ¥220)' },
      { time: '14:30', emoji: '💑', text: '♨️ **PRIVATE COUPLES ONSEN at Juhachiro (十八楼)** — 300-year ryokan on Nagara River. Kashikiri buro (貸切風呂) ¥3,000-5,000 for 45-60 min. Riverside rotenburo dengan river views. **Book ahead malem ini!**' },
      { time: '15:30', emoji: '🚶', text: 'Post-onsen walk along Nagara River. Total relaxation mode.' },
      { time: '16:00', emoji: '🍵', text: 'Tea/café Kawaramachi old town. Browse craft shops, sake brewery quick stop.' },
      { time: '17:00', emoji: '🚌', text: 'Bus back to Gifu Station → Hotel Livemax' },
      { time: '18:30', emoji: '🍽️', text: 'Dinner local izakaya station area — real Japanese prices ¥800-1,500/dish' },
      { time: '20:00', emoji: '💪', text: 'OPTIONAL: Late gym session kalau lu skip Day 6 evening (Faisal kerja besok Day 10, jadi gym Gifu OK relaxed pace)' },
      { time: '21:30', emoji: '☕', text: 'Konbini snack run atau cafe relax — Gifu evening pretty quiet' },
      { time: '22:00', emoji: '😴', text: 'Rest — Takayama adventure starts tomorrow!' },
    ],
    tips: [
      '🏨 **Hotel Livemax** = bukan Dormy Inn, gak ada free ramen + rooftop onsen. Tapi Juhachiro private onsen Day 7 = highlight beneran, lebih premium experience.',
      '🌸 Monet\'s Pond = hidden gem — very few foreign tourists know. Local Japanese-only crowd.',
      '⚠️ **CRITICAL: CHECK BUS SCHEDULE malem sebelum!** Gifu Bus ke Itadori cuma 3-4x/hari. Miss bus = stuck 2-3 jam.',
      'Kalau bus timing gak cocok, taxi ~¥10,000 one way (40 min). Split couple = ¥5K each.',
      '✅ Same hotel Livemax 2 malam = gak repacking/checkout. Leave bags di room, travel light ke pond.',
      '🍶 Gifu = NOT touristy → real Japanese izakaya prices. Ayu sweetfish (April season) WAJIB coba.',
      '♨️ **Juhachiro booking via phone +81-58-265-1551** atau via Booking.com (kadang ada). Reserve evening Day 6 buat Day 7 14:30 slot.',
    ],
  },
  {
