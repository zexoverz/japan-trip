...
const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '07:35', emoji: '🚶', text: '🗺️ Hotel → Station: WALK 7 min west to Takayama Station. Cross the bridge back toward the station.' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '09:30', emoji: '🏨', text: 'Check out APA Hotel Akihabara' },
      { time: '09:35', emoji: '🚶', text: '🗺️ Hotel → Station: WALK 3-5 min to Akihabara Station.' },
