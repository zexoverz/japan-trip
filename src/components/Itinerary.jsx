...
const days = [
  ...
  },
  {
    ...
    summary: 'EFFICIENT one-way traverse: Turun di Taisho Pond stop (bus stop pertama) → walk EAST → Tashiro Marsh → Kappabashi Bridge → Myojin Pond (TURNAROUND) → walk WEST back ke Kappabashi → naik bus dari Bus Terminal. ~10km zero backtrack, 5-6 jam total. Back Takayama 17:30 dinner.',
    ...
    schedule: [
      ...
      { time: '07:50', emoji: '🚌', text: '🎯 **TURUN DI TAISHO POND STOP** (1st bus stop, sebelum Terminal). Tell driver: "Taisho Ike de oroshite kudasai" (大正池で降ろしてください). Strategi efisien: walk EAST one-way, no backtrack.' },
      { time: '08:00', emoji: '📍', text: '**TAISHO POND (大正池)** — 30 min foto. Mountain reflection di still water, dead trees haunting beauty from 1915 Mt. Yakedake eruption. (0 km)' },
      { time: '08:30', emoji: '🚶', text: 'Walk **EAST** along Azusa River path' },
      { time: '09:00', emoji: '🌿', text: '**Tashiro Pond/Marsh** — boardwalk quick stop 15 min (1.5 km cum)' },
      { time: '09:30', emoji: '🚶', text: 'Continue EAST 1.5km' },
      { time: '09:45', emoji: '🌉', text: '**KAPPABASHI BRIDGE (河童橋) — ICONIC SPOT #1** (3 km cum). Suspension bridge, 3,190m Hotaka peaks backdrop. 30 menit photo + water refill.' },
      { time: '10:15', emoji: '🚶', text: 'Walk EAST 3.5km along Azusa River → Myojin direction' },
      { time: '11:30', emoji: '⛩️', text: '**MYOJIN POND (明神池) — TURNAROUND** (6.5 km cum). Sacred pond + Hotaka Jinja Okumiya shrine ¥300. Paling pristine forest setting.' },
      { time: '12:00', emoji: '🍙', text: '**LUNCH by Myojin pond** — konbini bento yang bawa dari Takayama. 45 min mountain serenity.' },
      { time: '— RETURN —', emoji: '↩️', text: '══════════════ ONE-WAY RETURN WEST ══════════════' },
      { time: '12:45', emoji: '🚶', text: 'Start walk WEST → Kappabashi (3.5 km, 1 jam gentle)' },
      { time: '14:00', emoji: '🌉', text: '**KAPPABASHI Round 2** (10 km cum) — golden afternoon light photos, different vibe dari pagi (mountain shadows beda)' },
      { time: '14:30', emoji: '☕', text: 'Kappabashi lodge pit stop — hot coffee ¥400, rest legs, restock water' },
      { time: '15:00', emoji: '🚶', text: 'Walk 5 min ke **Bus Terminal Kappabashi** (上高地バスターミナル, final bus stop)' },
    ...
    tips: [
      '🎯 **EFFICIENT ROUTE TIP:** Bus Nohi Kamikochi line stops di 3 tempat — Taisho Pond (1st), Imperial Hotel front, Bus Terminal (final). **TURUN DI TAISHO POND STOP** (1st stop), bukan Terminal. Tell driver: "Taisho Ike de oroshite kudasai". Walk one-way EAST to Myojin → return to Kappabashi → catch bus at Terminal. Zero backtrack vs Terminal-start route.',
