...
const days = [
  ...
  },
  {
    ...
    summary: 'Travel Takayama → Tokyo via NOHI BUS Highway (Takayama-Shinjuku Line, ¥7,500/orang WEB discount = ¥15K couple, save ~Rp 2.1M vs JR Hida+Shinkansen). 5h45min ride. Then Akihabara card hunt + Shimokitazawa MEGA HAUL Sesi 3.',
    dayCost: '¥18,000-25,000 (bus ¥15K couple + lunch + Tokyo + dinner)',
    schedule: [
      ...
      { time: '06:30', emoji: '⏰', text: 'Wake, breakfast (konbini atau hotel kalau included)' },
      { time: '07:00', emoji: '📦', text: 'Final pack — cards/cartridges/Prada hand-carry; koper 2x underbus-ready' },
      { time: '07:30', emoji: '📦', text: 'CHECK OUT Country Hotel Takayama' },
      { time: '07:35', emoji: '🚶', text: '🗺️ Hotel → **Takayama Nohi Bus Center** (5 min walk, sebelahan station)' },
      { time: '07:50', emoji: '🎫', text: 'Show booking confirmation di counter, load 2 koper underbus (driver bantu)' },
      { time: '08:30', emoji: '🚌', text: '🎯 **NOHI BUS Takayama-Shinjuku Line DEPART** — Operator: Nohi Bus + Keio joint. ¥7,500/orang WEB discount (¥8,000 walk-up). 5h 45min direct ke Shinjuku.' },
      { time: '— RIDE —', emoji: '🪟', text: 'Window seat KIRI = mountain views Hida → Matsumoto valley. WiFi onboard biasanya ada. Charge HP, snack, scroll, sleep.' },
      { time: '~10:30', emoji: '☕', text: 'Mid-route rest stop ~15 min (Hirayu Onsen atau Matsumoto SA) — toilet + stretch + grab coffee' },
      { time: '14:15', emoji: '🏙️', text: 'Arrive **Shinjuku Expressway Bus Terminal (バスタ新宿)**' },
      { time: '14:25', emoji: '🚃', text: 'JR Yamanote Line: Shinjuku → Akihabara (~17 min, ¥170 Suica)' },
      { time: '14:45', emoji: '🚶', text: 'Walk 5 min Akihabara Station → **Super Hotel Lohas Akihabara**' },
      { time: '15:00', emoji: '🏨', text: 'Check in Super Hotel. Drop bags. Cards/cartridge/Prada stay with you. 🎯' },
      { time: '— OPTIONAL GYM —', emoji: '💪', text: '══════════════ OPTIONAL STRENGTH SESSION ══════════════' },
      { time: '— CARD HUNT —', emoji: '🃏', text: '══════════════ AKIHABARA + SHIMOKITAZAWA ══════════════' },
      { time: '15:30', emoji: '🃏', text: '**Mandarake Complex Akihabara** — floors 3-5 TCG. PSA slabs, vintage promos. ⭐ flagship.' },
      { time: '16:30', emoji: '🃏', text: '**Surugaya Akihabara** — multiple locations Chuo-dori. Compare prices.' },
      { time: '17:00', emoji: '🃏', text: '**Yuyu-tei physical store Akihabara** — best buat One Piece raw singles. Same prices as online.' },
      { time: '17:30', emoji: '🃏', text: '**Card Rush + Book Off Akihabara** — check glass cases random steals' },
      { time: '18:00', emoji: '🚃', text: 'Train Akiba → Shinjuku → Shimokitazawa (JR + Odakyu, ~30 min)' },
      ...
      { time: '21:30', emoji: '📦', text: 'Back Super Hotel Akihabara. Organize purchases. Nakano Broadway skip — balik Day 13 kalau perlu. **NO gym option Day 12** (bus + travel + walking 15K steps = active enough).' },
    ],
    tips: [
      '🚌 **NOHI BUS Takayama-Shinjuku Line (verified Apr-May 2026):** ¥8,000 walk-up / **¥7,500 WEB discount** via highwaybus.com. Couple ¥15,000-16,000. ⚠️ RESERVATION REQUIRED — book Day 11 evening. Operator: Nohi Bus + Keio Bus joint.',
      '💰 **Bus vs JR Hida+Shinkansen:** Bus ¥15K couple vs JR ¥34.6K = **savings ¥19,600 (~Rp 2.1M)** for +1h 45min travel time. BTC maxi value-hunter win. Direct Takayama→Shinjuku, no transfer.',
      '⏰ **Departures Saturday May 2:** 06:30, 08:30 ⭐ recommended, 10:30, 13:30, 15:00, 17:10. Bus 08:30 = arrive Shinjuku 14:15, allows full afternoon Tokyo card hunt.',
      '📞 **Booking:** highwaybus.com (English, ¥500/orang WEB discount with credit card) atau phone 0577-32-1688 atau walk-in Takayama Nohi Bus Center counter.',
      '🎒 **Bagasi:** 2 koper underbus compartment OK. Cards/Prada/cartridge HAND-CARRY (vibration risk). Daypack di seat space.',
      '⏰ **Tokyo arrive 14:15 → start card hunt 15:30.** 6+ jam shopping window — Mandarake, Surugaya, Yuyu-tei, Shimokitazawa thrift Sesi 3.',
