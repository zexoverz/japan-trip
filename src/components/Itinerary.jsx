...
const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '12:37', emoji: '🚶', text: 'Walk 4 min east → K\'s House Takayama (4-45-1 Tenman-cho, just past bridge)' },
      { time: '12:45', emoji: '🏨', text: 'Drop bags K\'s House front desk (check-in 15:00, mereka simpen free). Cards stay with lu.' },
      ...
      { time: '17:30', emoji: '🏨', text: 'Formal check-in K\'s House — settle into room, change' },
      { time: '18:00', emoji: '🍺', text: 'Craft beer Takayama Brewery atau craft beer Wolf — local pints ¥600-800' },
      { time: '19:00', emoji: '🍽️', text: '**Dinner: Hoba Miso preview** — miso grilled on magnolia leaf with Hida beef + mountain veggies. Atau Hida beef teppanyaki Matsuki Kenji (reserve!) atau hoba miso Kyoya. ¥3-5K/orang.' },
      { time: '21:00', emoji: '📦', text: 'Rest, prep Day 9 Kamikochi: konbini bento bawa pagi, daypack ready, alarm 05:00' },
      { time: '22:00', emoji: '😴', text: 'Sleep early — Kamikochi 9-10km hike + 1.5h bus each way tomorrow!' },
    ],
    tips: [
      '🚌 **Nohi Bus tips:** 1) Suica gak work, bawa **cash ¥5,800** atau credit card di counter. 2) **Arrive 15 min early** Platform 6 buat load koper underbus. 3) Driver/staff bantu load — gak perlu angkat sendiri. 4) Window seat KIRI = Hida River views.',
      '💰 **Savings vs JR Hida Express:** ¥5,420 (Rp 580K) couple. JR Hida ¥5,610/orang vs Nohi Bus ¥2,900/orang, +14 menit travel only. BTC maxi worth it.',
      '🎴 **Cards/cartridges HAND-CARRY:** vibration + temperature swing underbus = damage potential. Pokemon cards di hard top loader, simpen daypack. Nintendo cartridges di inner pocket.',
      '🏘️ **Sanmachi closes early** ~17:00 most shops. Sake breweries 17:00-18:00 last tasting. Plan sightseeing 13:00-17:00 window.',
      '🥩 **Hida beef sushi street** — ¥600-800/piece, BEST ¥800 spend Jepang. Multiple stalls Sanmachi corner.',
      '🍶 **Sake brewery free tasting:** sugidama cedar ball outside = ready buat tasting. Funasaka most tourist-friendly (English menu, ¥500/flight). Harada smaller intimate. Niki oldest.',
      '🛏️ **K\'s House** = guesthouse vibe, not luxury hotel. Shared facilities possible. Check booking type: private room atau dorm.',
      '🌅 **Day 9 prep tonight:** Bawa konbini bento (2x onigiri + protein bar + thermos hot drink) — pagi gak ada waktu beli. Bus Kamikochi 06:30 dari Takayama Nohi Bus Center (sama tempat lu turun hari ini).',
    ],
  },
  {
