...
const days = [
  ...
  {
    day: 3, date: 'Apr 23 (Thu)', title: 'Arashiyama via Hozugawa Boat 🛶🎋',
    city: 'Kyoto', cityColor: 'bg-orange-100 text-orange-600',
    theme: '🛶 River Boat + Arashiyama',
    isBicycleDay: false,
    weather: { tag: '🌤️ Sejuk', temp: '9-19°C', level: 'mild' },
    fitness: { type: 'legs', label: '🦵 Light Legs (opsional)', detail: '6:00 opsional legs ringan 30 menit kalau badan masih fresh (recovery dari Fushimi kemarin). Atau skip, simpen energi buat boat + Arashiyama afternoon. Squats 3×15, lunges 3×10, glute bridges 3×15 — 20 menit done.' },
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=600&q=75',
    summary: 'Morning Hozugawa traditional boat 2 jam down river dari Kameoka → Arashiyama. Siang-sore: Bamboo Grove, Tenryuji, Monkey Park, Togetsukyo bridge.',
    dayCost: '¥9,000-11,000 (boat + temples + food)',
    schedule: [
      { time: '06:00', emoji: '🦵', text: 'Opsional: Light legs 20 min (squats 3×15, lunges 3×10, glute bridges 3×15). Atau skip — recovery dari Fushimi kemarin.' },
      { time: '06:30', emoji: '🚿', text: 'Shower → breakfast → pack daypack (kamera, sunblock, topi, light jacket/BlockTech Parka, water, cash ¥2K)' },
      { time: '07:45', emoji: '🚶', text: '🗺️ Hotel → Kyoto Station: WALK 8 min south dari Piece Hostel' },
      { time: '08:00', emoji: '🚃', text: 'JR Sagano Line: Kyoto → Kameoka Station (~28 min, ¥420, **covered by JR Pass!**). Trains tiap 15-20 min.' },
      { time: '08:35', emoji: '🏙️', text: 'Arrive Kameoka Station' },
      { time: '08:40', emoji: '🚶', text: '🗺️ Station → Boat dock: WALK 8 min flat, signposted untuk tourist. Follow "保津川下り" signs.' },
      { time: '08:50', emoji: '🎫', text: 'Check-in Hozugawa Yusen (booking dulu via hozugawakudari.jp — Golden Week wajib book!). ¥6,000/dewasa.' },
      { time: '09:00', emoji: '🛶', text: '🎯 **HOZUGAWA KUDARI BOAT DEPART** — 2 jam down river! Traditional flat-bottom boat, 3 boatmen with bamboo poles, gorge scenery, koi, cherry leftovers kalau beruntung.' },
      { time: '09:30', emoji: '🌊', text: 'Mid-journey: boat kadang berhenti di floating vendor — jual minum, snack, mochi (¥300-500 each). Fun moment!' },
      { time: '10:30', emoji: '📸', text: 'Final gorge section: tebing tajam di kanan-kiri, boat zig-zag melewati batu besar' },
      { time: '11:00', emoji: '🌉', text: 'Arrive Arashiyama via boat — disembark dekat Togetsukyo Bridge' },
      { time: '11:15', emoji: '📸', text: 'Togetsukyo Bridge photos — THE iconic Arashiyama shot dengan mountains backdrop' },
      { time: '11:30', emoji: '🍜', text: 'Early lunch di Arashiyama main street — yudofu (tofu hot pot) khas Kyoto, warabi mochi, atau kaiseki simple ¥1,200-2,500' },
      { time: '12:45', emoji: '🎋', text: 'Bamboo Grove — afternoon lebih ramai dari dawn, tapi masih magical. 30-45 menit. FREE entry.' },
      { time: '13:30', emoji: '⛩️', text: 'Tenryuji Temple + garden — UNESCO World Heritage, stunning zen garden ¥500. 45 menit.' },
      { time: '14:30', emoji: '🐒', text: 'Iwatayama Monkey Park — 20 min hike up, feed wild monkeys (DARI DALAM cage — monkeys free outside) ¥550. Panoramic Kyoto view di puncak.' },
      { time: '16:00', emoji: '⛩️', text: 'Opsional: Gio-ji moss temple (very quiet, magical) ¥300 atau Nonomiya Shrine (bamboo forest entry)' },
      { time: '16:45', emoji: '☕', text: '% Arabica Arashiyama atau matcha stand — coffee/matcha break dengan view river' },
      { time: '17:30', emoji: '🚃', text: 'JR Saga-Arashiyama → Kyoto Station (15 min, covered by JR Pass)' },
      { time: '18:30', emoji: '🍽️', text: 'Dinner: okonomiyaki atau Kyoto-style ramen (soy base, lighter) di central Kyoto' },
    ],
    tips: [
      '⚠️ **BOOK BOAT TONIGHT** — hozugawakudari.jp atau call +81-771-22-5846. Golden Week approaching, capacity ~30 per boat, rawan full!',
      'Pilih departure 09:00 atau 10:00 — first 2 boats = less crowded + full afternoon masih sisa.',
      'Duduk ujung KANAN perahu = pilot side, view terbaik.',
      'Bawa BlockTech Parka di daypack — 2 jam di atas air = angin kenceng bisa dingin walau sunny.',
      'Sunblock + topi wajib — perahu terbuka, exposed matahari.',
      'Toilet pre-boat! Gak ada toilet 2 jam di perahu.',
      'Cash ¥1-2K buat floating vendor (snack/minum) — experience unik, jangan skip.',
      '⚠️ Boat CANCEL kalau river tinggi / hujan deras. Cek tenki.jp (Kameoka) subuh sebelum berangkat. Plan B: skip boat, jalankan original Arashiyama tour dari Saga-Arashiyama station.',
      'JR Sagano Line + Torokko Scenic Railway = covered JR Pass, tapi **Hozugawa boat BUKAN** covered (¥6K cash/card).',
    ],
  },
  {
